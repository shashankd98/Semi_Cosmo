...
def main():
    ...
    ax1.loglog(r/R200m,phi_true-phi_true[0],label='Construction 2')
    ax1.loglog(r/R200m,phi_sol-phi_sol[0],label="Construction 1")
    ...
    ax2.loglog(rm1/R200m,-g_fit)
    ax2.loglog(rm1/R200m,-g_true)
    ax2.loglog(rm1/R200m,-g_sol)
